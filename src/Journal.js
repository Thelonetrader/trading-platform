    ...
    <div>
      ...
      {showForm && (
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 600, color: '#f1f5f9', marginBottom: 20 }}>Log New Trade</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end' }}>
              <div style={{
                ...
                <div style={{ fontSize: 11, color: '#475569', marginBottom: 2 }}>Estimated P&L</div>
                <div style={{
                  fontSize: 16,
                  fontWeight: 700,
            ...
            <tbody>
              {trades.map((trade, i) => (
                <tr key={trade.id} style={{
                  ...
                  <td style={{ padding: '12px 16px', fontSize: 13, color: '#94a3b8' }}>£{trade.entryPrice}</td>
                  <td style={{ padding: '12px 16px', fontSize: 13, color: '#94a3b8' }}>£{trade.exitPrice || '—'}</td>
                  <td style={{ padding: '12px 16px', fontSize: 13, color: '#94a3b8' }}>{trade.shares}</td>
